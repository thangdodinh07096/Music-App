...
//    }
    ...
    private fun updatePlayingInfo(restore: Boolean, startPlay: Boolean) {
        ...
        val minus = (duration / 60000).toString()
        val milise = ((duration % 60000) / 1000).toString()
        val time = "" + minus + ":" + milise
    ...
    internal inner class PlaybackListener : PlaybackInfoListener() {
        ...
        override fun onPositionChanged(position: Int) {
            if (!mUserIsSeeking) {
                ...
                val minus = if ((position / 60000).toString().isEmpty()) "0" else (position / 60000).toString()
                val milise = if (((position % 60000) / 1000).toString().isEmpty()) "0" else ((position % 60000) / 1000).toString()
                val time = "" + minus + ":" + milise
                time_play_txt.setText(time)
            }
        }
